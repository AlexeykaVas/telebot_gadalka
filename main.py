...
import random
import secrets
#5921129133:AAFTuqmVcEBkoo7Y0jazidXAoFeVrJXZnsM
...
def callback_inline2(callback_query: types.CallbackQuery):
    ...
    if len(sp[aaa1]) == 0:
        ...
        bot.send_message(callback_query.from_user.id, text='Your random word: '+random.choice(sp[aaa1]))
...
def randomq(message):
    ...
    if len(sp[aaa1]) == 0:
        ...
        bot.send_message(message.chat.id, text='Your random word: '+random.choice(sp[aaa1]))
